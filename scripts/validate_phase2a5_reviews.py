#!/usr/bin/env python3
"""Validate an isolated package-bound Phase 2A.5 reviewer export."""
...
from src.validation.phase2a5_package import (  # noqa: E402
    ...
    validate_phase2a5_review_export,
)
...
def main(package_root: Path, review_export: Path) -> None:
    try:
        result = validate_phase2a5_review_export(package_root, review_export)
